(()=>{let e;var t=Object.assign(Object.create(null),{url:"file:///assets/js/fetchApis.js"});async function n(){try{let t=await fetch(e);return await t.json()}catch(e){console.error("Erro ao buscar dados:",e)}}"undefined"!=typeof process&&process.env?e=process.env.API_URL||"https://instabyte-back-end-262694944609.southamerica-east1.run.app/posts":e=t.env&&t.env.API_URL||"https://instabyte-back-end-262694944609.southamerica-east1.run.app/posts";let a=document.getElementById("modal"),s=document.getElementById("modal-img"),c=document.getElementById("caption"),o=document.querySelector(".close");a.style.display="none";let r=document.querySelector(".image-grid");async function i(){let e=await n();try{let t=e.map(e=>`
...
//# sourceMappingURL=index.a0791f57.js.map
