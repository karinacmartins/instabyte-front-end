const e=process.env.API_URL;async function t(){try{let t=await fetch(e);return await t.json()}catch(e){console.error("Erro ao buscar dados:",e)}}const n=document.getElementById("modal"),c=document.getElementById("modal-img"),o=document.getElementById("caption"),i=document.querySelector(".close");n.style.display="none";const r=document.querySelector(".image-grid");async function a(){let e=await t();try{let t=e.map(e=>`
...
//# sourceMappingURL=index.776254f8.js.map
