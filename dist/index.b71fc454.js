const e=window.API_URL;async function t(){try{let t=await fetch(e);return await t.json()}catch(e){console.error("Erro ao buscar dados:",e)}}const n=document.getElementById("modal"),o=document.getElementById("modal-img"),c=document.getElementById("caption"),i=document.querySelector(".close");n.style.display="none";const a=document.querySelector(".image-grid");async function r(){let e=await t();try{let t=e.map(e=>`
...
//# sourceMappingURL=index.b71fc454.js.map
