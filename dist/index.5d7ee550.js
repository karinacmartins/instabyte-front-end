(()=>{async function e(){try{let e=await fetch("https://instabyte-back-end-262694944609.southamerica-east1.run.app/posts",{headers:{"Content-Type":"application/json"}});return await e.json()}catch(e){console.error("Erro ao buscar dados:",e)}}let t=document.getElementById("modal"),n=document.getElementById("modal-img"),a=document.getElementById("caption"),o=document.querySelector(".close");t.style.display="none";let c=document.querySelector(".image-grid");async function i(){let o=await e();try{let e=o.map(e=>`
...
//# sourceMappingURL=index.5d7ee550.js.map
